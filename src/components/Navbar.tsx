...
const Navbar = ({ onScrollToSection = () => {} }: NavbarProps) => {
    ...
    const navLinks = [
        ...
        { name: "Câu chuyện của chúng tôi", section: "story" },
        { name: "Sản phẩm đặc trưng", section: "features" },
        { name: "Khách hàng nói gì", section: "testimonials" },
        { name: "Liên hệ", section: "footer" },
    ];
